#!/bin/bash
# Fixed-config seed reruns for backbone-sweep MLP probes.
# Manifest: results/seed_runs/seed_manifest_layerwise_backbone_sweep_linear_mlp_v1.csv

#SBATCH --partition=rome
#SBATCH --job-name=seed_bs_mlp
#SBATCH --array=0-47%4
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=06:00:00
#SBATCH --output=output/training/seed_runs/layerwise_backbone_sweep_mlp/seed_bs_mlp_%A_%a.out
#SBATCH --error=output/training/seed_runs/layerwise_backbone_sweep_mlp/seed_bs_mlp_%A_%a.err
