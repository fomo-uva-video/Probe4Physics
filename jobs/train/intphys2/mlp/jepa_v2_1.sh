#!/bin/bash
# Train a IntPhys2 mlp probe with jepa_v2_1 features.
#
# Usage:
#   sbatch jepa_v2_1.sh
...
#SBATCH --job-name=intphys2_jepa_v2_1_mlp
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=02:00:00
#SBATCH --output=output/training/intphys2/mlp/intphys2_jepa_v2_1_mlp_layers_%j.out
#SBATCH --error=output/training/intphys2/mlp/intphys2_jepa_v2_1_mlp_layers_%j.err
