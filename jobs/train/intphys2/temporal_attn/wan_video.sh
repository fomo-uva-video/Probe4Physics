#!/bin/bash
# Train IntPhys2 temporal_attn probes with wan_video token features.
#
# Usage:
#   sbatch wan_video.sh
...
#SBATCH --job-name=intphys2_wan_video_temporal_attn
#SBATCH --ntasks=1
#SBATCH --gpus=1
#SBATCH --cpus-per-task=9
#SBATCH --mem=128G
#SBATCH --time=12:00:00
#SBATCH --output=output/training/intphys2/attention/intphys2_wan_attn_layers_%j.out
#SBATCH --error=output/training/intphys2/attention/intphys2_wan_attn_layers_%j.err
