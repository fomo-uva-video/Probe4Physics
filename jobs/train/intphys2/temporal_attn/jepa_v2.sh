#!/bin/bash
# Train a IntPhys2 temporal_attn probe with jepa_v2 features.
#
# Usage:
#   sbatch jepa_v2.sh
...
#SBATCH --job-name=intphys2_jepa_v2_temporal_attn
#SBATCH --ntasks=1
#SBATCH --gpus=1
#SBATCH --cpus-per-task=9
#SBATCH --mem=176G
#SBATCH --time=10:00:00
#SBATCH --output=output/training/intphys2/attention/intphys2_jepa_v2_attn_layers_%j.out
#SBATCH --error=output/training/intphys2/attention/intphys2_jepa_v2_attn_layers_%j.err
