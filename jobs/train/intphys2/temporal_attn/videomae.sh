#!/bin/bash
# Train a IntPhys2 temporal_attn probe with videomae features.
#
# Usage:
#   sbatch videomae.sh
...
#SBATCH --job-name=intphys2_videomae_temporal_attn
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=02:00:00
#SBATCH --output=output/training/intphys2/attention/intphys2_videomae_attn_layers_%j.out
#SBATCH --error=output/training/intphys2/attention/intphys2_videomae_attn_layers_%j.err
