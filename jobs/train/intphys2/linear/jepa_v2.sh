#!/bin/bash
# Train a IntPhys2 linear probe with jepa_v2 features.
#
# Usage:
#   sbatch jepa_v2.sh
...
#SBATCH --output=output/training/intphys2/linear/intphys2_jepa_v2_linear_layers_%j.out
#SBATCH --error=output/training/intphys2/linear/intphys2_jepa_v2_linear_layers_%j.err
