...
#SBATCH --output=output/training/intphys2/linear/intphys2_jepa_v2_1_linear_layers_%j.out
#SBATCH --error=output/training/intphys2/linear/intphys2_jepa_v2_1_linear_layers_%j.err
