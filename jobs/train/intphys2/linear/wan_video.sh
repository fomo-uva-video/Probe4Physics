#!/bin/bash
# Train an IntPhys2 linear probe with wan_video features.
#
# Usage:
#   sbatch wan_video.sh
...
#SBATCH --job-name=intphys2_wan_video_linear
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=08:00:00
#SBATCH --output=output/training/intphys2/linear/intphys2_wan_linear_layers_%j.out
#SBATCH --error=output/training/intphys2/linear/intphys2_wan_linear_layers_%j.err
