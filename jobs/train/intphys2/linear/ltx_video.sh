#!/bin/bash
# Train a IntPhys2 linear probe with ltx_video features.
#
# Usage:
#   sbatch ltx_video.sh
...
#SBATCH --output=output/training/intphys2/linear/intphys2_ltx_linear_layers_%j.out
#SBATCH --error=output/training/intphys2/linear/intphys2_ltx_linear_layers_%j.err
