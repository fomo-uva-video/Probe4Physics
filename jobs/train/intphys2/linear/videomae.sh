#!/bin/bash
# Train a IntPhys2 linear probe with videomae features.
#
# Usage:
#   sbatch videomae.sh
...
#SBATCH --output=output/training/intphys2/linear/intphys2_videomae_linear_layers_%j.out
#SBATCH --error=output/training/intphys2/linear/intphys2_videomae_linear_layers_%j.err
