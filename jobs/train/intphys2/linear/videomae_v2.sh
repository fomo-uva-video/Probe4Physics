#!/bin/bash
# Train a IntPhys2 linear probe with videomae_v2 features.
#
# Usage:
...
#SBATCH --output=output/training/intphys2/linear/intphys2_videomae_v2_linear_layers_%j.out
#SBATCH --error=output/training/intphys2/linear/intphys2_videomae_v2_linear_layers_%j.err
