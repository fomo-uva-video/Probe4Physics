#!/bin/bash
# Train SSv2 linear probes with wan_video features.
#
# Usage:
#   sbatch wan_video.sh
...
#SBATCH --job-name=ssv2_wan_video_linear
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=02:00:00
#SBATCH --output=output/training/ssv2/linear/ssv2_wan_linear_layers_%j.out
#SBATCH --error=output/training/ssv2/linear/ssv2_wan_linear_layers_%j.err
