...
#SBATCH --job-name=ssv2_jepa_v1_linear_layers
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=02:00:00
#SBATCH --output=output/training/ssv2/linear/ssv2_jepa_v1_linear_layers_%j.out
#SBATCH --error=output/training/ssv2/linear/ssv2_jepa_v1_linear_layers_%j.err
