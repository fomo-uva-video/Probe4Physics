#!/bin/bash
# Train SSv2 temporal_attn probes with wan_video token features.
#
# Usage:
#   sbatch wan_video.sh
...
#SBATCH --job-name=ssv2_wan_video_temporal_attn
#SBATCH --ntasks=1
#SBATCH --gpus=1
#SBATCH --cpus-per-task=9
#SBATCH --mem=128G
#SBATCH --time=12:00:00
#SBATCH --output=output/training/ssv2/attention/ssv2_wan_attn_layers_%j.out
#SBATCH --error=output/training/ssv2/attention/ssv2_wan_attn_layers_%j.err
