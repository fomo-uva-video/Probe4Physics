#!/bin/bash
# Train SSv2 MLP probes with wan_video features.
#
# Usage:
#   sbatch wan_video.sh
...
#SBATCH --job-name=ssv2_wan_video_mlp
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=02:00:00
#SBATCH --output=output/training/ssv2/mlp/ssv2_wan_mlp_layers_%j.out
#SBATCH --error=output/training/ssv2/mlp/ssv2_wan_mlp_layers_%j.err
