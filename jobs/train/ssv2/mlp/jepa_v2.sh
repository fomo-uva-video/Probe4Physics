#!/bin/bash
# Train a SSv2 mlp probe with jepa_v2 features.
#
# Usage:
#   sbatch jepa_v2.sh
...
#SBATCH --job-name=ssv2_jepa_v2_mlp
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=02:00:00
#SBATCH --output=output/training/ssv2/mlp/ssv2_jepa_v2_mlp_layers_%j.out
#SBATCH --error=output/training/ssv2/mlp/ssv2_jepa_v2_mlp_layers_%j.err
