#!/bin/bash
# Train a MVP temporal_attn probe with ltx_video features.
#
# Usage:
#   sbatch ltx_video.sh
...
#SBATCH --job-name=mvp_ltx_video_temporal_attn
#SBATCH --ntasks=1
#SBATCH --gpus=1
#SBATCH --cpus-per-task=9
#SBATCH --mem=192G
#SBATCH --time=10:00:00
#SBATCH --output=output/training/mvp/attention/mvp_ltx_attn_layers_%j.out
#SBATCH --error=output/training/mvp/attention/mvp_ltx_attn_layers_%j.err
