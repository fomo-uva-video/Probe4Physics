...
#
# Usage:
#   jobs/train/mvp/temporal_attn/submit_jepa_v1_timing_experiments.sh
#   TIMING_GROUP=my_group jobs/train/mvp/temporal_attn/submit_jepa_v1_timing_experiments.sh
#   DRY_RUN=1 jobs/train/mvp/temporal_attn/submit_jepa_v1_timing_experiments.sh
