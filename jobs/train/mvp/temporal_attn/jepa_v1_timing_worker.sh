...
#
# Usage:
#   sbatch jobs/train/mvp/temporal_attn/jepa_v1_timing_worker.sh
#   sbatch --export=ALL,EXPERIMENT_MODE=storage_fix jobs/train/mvp/temporal_attn/jepa_v1_timing_worker.sh
#   sbatch --export=ALL,EXPERIMENT_MODE=storage_fix_bs4 jobs/train/mvp/temporal_attn/jepa_v1_timing_worker.sh
#   sbatch --export=ALL,EXPERIMENT_MODE=storage_fix_bs8 jobs/train/mvp/temporal_attn/jepa_v1_timing_worker.sh
