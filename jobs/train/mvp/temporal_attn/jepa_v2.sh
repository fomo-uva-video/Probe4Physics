#!/bin/bash
# Train a MVP temporal_attn probe with jepa_v2 features.
#
# Usage:
#   sbatch jepa_v2.sh
...
#SBATCH --job-name=mvp_jepa_v2_temporal_attn
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=02:00:00
#SBATCH --output=output/training/mvp/attention/mvp_jepa_v2_attn_layers_%j.out
#SBATCH --error=output/training/mvp/attention/mvp_jepa_v2_attn_layers_%j.err
