#!/bin/bash
# Train a single MVP MLP probe with wan_video features.
#
# Usage:
#   sbatch wan_video.sh
...
#SBATCH --job-name=mvp_wan_video_mlp
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=02:00:00
#SBATCH --output=output/training/mvp/mlp/mvp_wan_mlp_smoke_%j.out
#SBATCH --error=output/training/mvp/mlp/mvp_wan_mlp_smoke_%j.err
