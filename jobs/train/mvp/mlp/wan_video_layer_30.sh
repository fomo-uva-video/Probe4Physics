#!/bin/bash
# Train MVP MLP probes with wan_video block-30 features across all default noise levels.
#
# Usage:
#   sbatch wan_video_layer_30.sh
#   sbatch wan_video_layer_30.sh probe.device=cpu

#SBATCH --partition=rome
#SBATCH --job-name=mvp_wan_video_mlp_l30
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=24:00:00
#SBATCH --output=output/training/mvp/mlp/mvp_wan_mlp_layer_30_%j.out
#SBATCH --error=output/training/mvp/mlp/mvp_wan_mlp_layer_30_%j.err
