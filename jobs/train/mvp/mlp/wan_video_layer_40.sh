#!/bin/bash
# Train MVP MLP probes with wan_video block-40 features across all default noise levels.
#
# Usage:
#   sbatch wan_video_layer_40.sh
#   sbatch wan_video_layer_40.sh probe.device=cpu

#SBATCH --partition=rome
#SBATCH --job-name=mvp_wan_video_mlp_l40
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=24:00:00
#SBATCH --output=output/training/mvp/mlp/mvp_wan_mlp_layer_40_%j.out
#SBATCH --error=output/training/mvp/mlp/mvp_wan_mlp_layer_40_%j.err
