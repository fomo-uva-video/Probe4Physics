#!/bin/bash
# Train MVP MLP probes with all default wan_video diffusion slots.
#
# Usage:
#   sbatch wan_video_layer_all.sh
#   sbatch wan_video_layer_all.sh probe.device=cpu

#SBATCH --partition=rome
#SBATCH --job-name=mvp_wan_video_mlp_all
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=15
#SBATCH --time=120:00:00
#SBATCH --output=output/training/mvp/mlp/mvp_wan_mlp_all_%j.out
#SBATCH --error=output/training/mvp/mlp/mvp_wan_mlp_all_%j.err
