#!/bin/bash
# Train MVP linear probes with wan_video block-40 features across all default noise levels.
#
# Usage:
#   sbatch wan_video_layer_40.sh
#   sbatch wan_video_layer_40.sh probe.device=cuda

#SBATCH --partition=gpu_a100
#SBATCH --job-name=mvp_wan_video_linear_l40
#SBATCH --ntasks=1
#SBATCH --gpus=1
#SBATCH --cpus-per-task=8
#SBATCH --time=24:00:00
#SBATCH --output=output/training/mvp/linear/mvp_wan_linear_layer_40_%j.out
#SBATCH --error=output/training/mvp/linear/mvp_wan_linear_layer_40_%j.err
...
# Wan default slots are 10 noise levels x 4 depths. These are the block-40 slots.
PROBE_LAYER="4"
PROBE_LAYERS="4, 8, 12, 16, 20, 24, 28, 32, 36, 40"
