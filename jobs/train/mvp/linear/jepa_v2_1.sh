...
# Usage:
#   sbatch jepa_v2_1.sh
#   sbatch jepa_v2_1.sh probe.device=cuda
...
#SBATCH --output=output/training/mvp/linear/mvp_jepa_v2_1_linear_layers_%j.out
#SBATCH --error=output/training/mvp/linear/mvp_jepa_v2_1_linear_layers_%j.err
