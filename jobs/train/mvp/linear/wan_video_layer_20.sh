#!/bin/bash
# Train MVP linear probes with wan_video block-20 features across all default noise levels.
#
# Usage:
#   sbatch wan_video_layer_20.sh
#   sbatch wan_video_layer_20.sh probe.device=cuda

#SBATCH --partition=gpu_a100
#SBATCH --job-name=mvp_wan_video_linear_l20
#SBATCH --ntasks=1
#SBATCH --gpus=1
#SBATCH --cpus-per-task=8
#SBATCH --time=24:00:00
#SBATCH --output=output/training/mvp/linear/mvp_wan_linear_layer_20_%j.out
#SBATCH --error=output/training/mvp/linear/mvp_wan_linear_layer_20_%j.err
...
# Wan default slots are 10 noise levels x 4 depths. These are the block-20 slots.
PROBE_LAYER="2"
PROBE_LAYERS="2, 6, 10, 14, 18, 22, 26, 30, 34, 38"
