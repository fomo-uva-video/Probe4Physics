#!/bin/bash
# Train a MVP linear probe with jepa_v1 features.
#
# Usage:
#   sbatch jepa_v1.sh
#   sbatch jepa_v1.sh probe.device=cuda

#SBATCH --partition=gpu_h100
#SBATCH --job-name=mvp_jepa_v1_linear_layers
#SBATCH --ntasks=1
#SBATCH --gpus=1
#SBATCH --cpus-per-task=8
#SBATCH --time=24:00:00
#SBATCH --output=output/training/mvp/linear/mvp_jepa_v1_linear_layers_%j.out
#SBATCH --error=output/training/mvp/linear/mvp_jepa_v1_linear_layers_%j.err
