#!/bin/bash
# Train a MVP linear probe with videomae_v2 features.
#
# Usage:
#   sbatch videomae_v2.sh
#   sbatch videomae_v2.sh probe.device=cuda
...
#SBATCH --output=output/training/mvp/linear/mvp_videomae_v2_linear_layers_%j.out
#SBATCH --error=output/training/mvp/linear/mvp_videomae_v2_linear_layers_%j.err
