...
#SBATCH --output=output/training/mvp/linear/mvp_ltx_linear_layer_12_%j.out
#SBATCH --error=output/training/mvp/linear/mvp_ltx_linear_layer_12_%j.err
...
PROBE_LAYERS="1, 5, 9, 13, 17, 21, 25, 29, 33, 37"  # subset of layers to train probes on
