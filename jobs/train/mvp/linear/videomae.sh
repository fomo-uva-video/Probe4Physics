#!/bin/bash
# Train a MVP linear probe with videomae features.
#
# Usage:
#   sbatch videomae.sh
#   sbatch videomae.sh probe.device=cuda
...
#SBATCH --output=output/training/mvp/linear/mvp_videomae_linear_layers_%j.out
#SBATCH --error=output/training/mvp/linear/mvp_videomae_linear_layers_%j.err
