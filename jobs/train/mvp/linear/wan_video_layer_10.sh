#!/bin/bash
# Train MVP linear probes with wan_video block-10 features across all default noise levels.
#
# Usage:
#   sbatch wan_video_layer_10.sh
#   sbatch wan_video_layer_10.sh probe.device=cuda

#SBATCH --partition=gpu_a100
#SBATCH --job-name=mvp_wan_video_linear_l10
#SBATCH --ntasks=1
#SBATCH --gpus=1
#SBATCH --cpus-per-task=8
#SBATCH --time=24:00:00
#SBATCH --output=output/training/mvp/linear/mvp_wan_linear_layer_10_%j.out
#SBATCH --error=output/training/mvp/linear/mvp_wan_linear_layer_10_%j.err
