#!/bin/bash
# Extract the MVP single-frame baseline with Wan features.
#
...
#   extract_jid=$(sbatch --parsable jobs/baseline/single_frame/mvp/extract/wan_video.sh)
#   sbatch --dependency=afterok:${extract_jid} --export=ALL,PROBE_OUTPUT_DIR=/scratch-shared/${USER}/probe4physics/artifacts/probes/mvp jobs/baseline/single_frame/mvp/eval/wan_video.sh
#
#SBATCH --partition=gpu_h100
#SBATCH --gpus=1
#SBATCH --job-name=mvp_sf_extract_wan_video
#SBATCH --ntasks=1
