...
#   extract_jid=$(sbatch --parsable jobs/baseline/single_frame/intphys2/extract/jepa_v2_1.sh)
#   sbatch --dependency=afterok:${extract_jid} --export=ALL,PROBE_OUTPUT_DIR=/scratch-shared/${USER}/probe4physics/artifacts/probes/intphys2 jobs/baseline/single_frame/intphys2/eval/jepa_v2_1.sh
