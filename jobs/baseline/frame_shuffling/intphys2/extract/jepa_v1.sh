...
#   extract_jid=$(sbatch --parsable jobs/baseline/frame_shuffling/intphys2/extract/jepa_v1.sh)
#   sbatch --dependency=afterok:${extract_jid} --export=ALL,PROBE_OUTPUT_DIR=/scratch-shared/${USER}/probe4physics/artifacts/probes/intphys2 jobs/baseline/frame_shuffling/intphys2/eval/jepa_v1.sh
