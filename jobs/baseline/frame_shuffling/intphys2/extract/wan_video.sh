#!/bin/bash
# Extract the IntPhys2 frame-shuffling baseline with Wan features.
#
...
#   extract_jid=$(sbatch --parsable jobs/baseline/frame_shuffling/intphys2/extract/wan_video.sh)
#   sbatch --dependency=afterok:${extract_jid} --export=ALL,PROBE_OUTPUT_DIR=/scratch-shared/${USER}/probe4physics/artifacts/probes/intphys2 jobs/baseline/frame_shuffling/intphys2/eval/wan_video.sh
#
#SBATCH --partition=gpu_h100
#SBATCH --gpus=1
#SBATCH --job-name=int_shuffle_extract_wan_video
#SBATCH --ntasks=1
