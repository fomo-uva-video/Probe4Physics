...
#   extract_jid=$(sbatch --parsable jobs/baseline/frame_shuffling/mvp/extract/jepa_v2.sh)
#   sbatch --dependency=afterok:${extract_jid} --export=ALL,PROBE_OUTPUT_DIR=/scratch-shared/${USER}/probe4physics/artifacts/probes/mvp jobs/baseline/frame_shuffling/mvp/eval/jepa_v2.sh
