#!/bin/bash
# Extract the MVP frame-shuffling baseline with Wan features.
#
...
#   extract_jid=$(sbatch --parsable jobs/baseline/frame_shuffling/mvp/extract/wan_video.sh)
#   sbatch --dependency=afterok:${extract_jid} --export=ALL,PROBE_OUTPUT_DIR=/scratch-shared/${USER}/probe4physics/artifacts/probes/mvp jobs/baseline/frame_shuffling/mvp/eval/wan_video.sh
#
#SBATCH --partition=gpu_h100
#SBATCH --gpus=1
#SBATCH --job-name=mvp_shuffle_extract_wan_video
#SBATCH --ntasks=1
