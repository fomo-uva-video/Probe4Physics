...
#   extract_jid=$(sbatch --parsable ops/hpc/baseline/single_frame/mvp/extract/videomae.sh)
#   sbatch --dependency=afterok:${extract_jid} --export=ALL,PROBE_OUTPUT_DIR=/scratch-shared/${USER}/probe4physics/artifacts/probes/mvp ops/hpc/baseline/single_frame/mvp/eval/videomae.sh
