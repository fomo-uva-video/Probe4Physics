#!/bin/bash
# Train a MVP temporal_attn probe with videomae_v2 features.
#
# Usage:
...
#SBATCH --job-name=mvp_videomae_v2_temporal_attn
#SBATCH --ntasks=1
#SBATCH --gpus=1
#SBATCH --cpus-per-task=9
#SBATCH --mem=192G
#SBATCH --time=10:00:00
#SBATCH --output=output/training/mvp/attention/mvp_videomae_v2_attn_layers_%j.out
#SBATCH --error=output/training/mvp/attention/mvp_videomae_v2_attn_layers_%j.err
