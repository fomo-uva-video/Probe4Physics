...
#SBATCH --output=output/training/ssv2/linear/ssv2_videomae_v2_linear_layers_%j.out
#SBATCH --error=output/training/ssv2/linear/ssv2_videomae_v2_linear_layers_%j.err
