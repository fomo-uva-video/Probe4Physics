#!/bin/bash
# Train a SSv2 linear probe with videomae features.
#
# Usage:
#   sbatch videomae.sh
...
#SBATCH --job-name=ssv2_videomae_linear
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=02:00:00
#SBATCH --output=output/training/ssv2/linear/ssv2_videomae_linear_layers_%j.out
#SBATCH --error=output/training/ssv2/linear/ssv2_videomae_linear_layers_%j.err
