#!/bin/bash
# Train a SSv2 mlp probe with ltx_video features.
#
# Usage:
#   sbatch ltx_video.sh
...
#SBATCH --job-name=ssv2_ltx_video_mlp
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=02:00:00
#SBATCH --output=output/training/ssv2/mlp/ssv2_ltx_mlp_layers_%j.out
#SBATCH --error=output/training/ssv2/mlp/ssv2_ltx_mlp_layers_%j.err
