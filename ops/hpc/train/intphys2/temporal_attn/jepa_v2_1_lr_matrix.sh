#!/bin/bash
# Train IntPhys2 temporal_attn probes with jepa_v2_1 features over a fixed
# (layer, learning-rate) matrix.
#
# Usage:
#   sbatch ops/hpc/train/intphys2/temporal_attn/jepa_v2_1_lr_matrix.sh
#
# Default matrix:
#   layers = 12, 24, 38, 48
...
BACKBONE_NAME="${BACKBONE_NAME:-jepa_v2_1}"
BACKBONE_VARIANT="${BACKBONE_VARIANT:-vitG_384}"
MATRIX_LAYERS="${MATRIX_LAYERS:-12,24,38,48}"
...
GROUP_SUBDIR="${GROUP_SUBDIR:-intphys2_probe_temporal_attn_jepa_v2_1_vitG_384_lr_matrix}"
WANDB_GROUP="${WANDB_GROUP:-intphys2_temporal_attn_jepa_v2_1_lr_matrix}"
